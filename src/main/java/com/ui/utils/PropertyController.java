...
import com.ui.utils.exceptions.NoSuchPropertyException;
...
public class PropertyController {
    ...
    public static final String WEBRDIVER = "browser";
    public static final String CHROMEPATH = "webdriver.chrome.driver";
    public static final String FIREFOXPATH = "webdriver.gecko.driver";
